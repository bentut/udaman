#STATE OF TESTING
#verify that sources are updating correctly when source is a pattern
#update front end to show pattern for pattern based sources
#turn off constant download flag in file diff method
#marking off each of the finished update spreadsheets in Noterize

task :test_mailer => :environment do
  NotificationMailer.deliver_new_download_notification "Monthly Construction (rake const_upd_m)", ""
end

task :test_text_file => :environment do
  
end

task :const_upd_q_template => :environment do
  require "Spreadsheet"
...
task :const_upd_m_template => :environment do
  require "Spreadsheet"
  pathHI           = "/Volumes/UHEROwork/data/rawdata/Const_MEI_HI.xls"
  pathHAW          = "/Volumes/UHEROwork/data/rawdata/Const_MEI_HAW.xls"
  pathHON          = "/Volumes/UHEROwork/data/rawdata/Const_MEI_HON.xls"
  pathMAU          = "/Volumes/UHEROwork/data/rawdata/Const_MEI_MAU.xls"
  pathKAU          = "/Volumes/UHEROwork/data/rawdata/Const_MEI_KAU.xls"
  ...
  if dsdHI.download_changed? || dsdHAW.download_changed? || dsdHON.download_changed? || dsdMAU.download_changed?  || dsdKAU.download_changed? || dsdPICT.download_changed? 
    ...
    sox.add "KPPRVCOMNS@HI.M",      Series.load_pattern("1990-01-01", "M", pathHI, "sheet_num:1", "increment:5:1", 43)
    sox.add "KPPRVADDNS@HI.M",      Series.load_pattern("1990-01-01", "M", pathHI, "sheet_num:1", "increment:5:1", 44)
    sox.add "KPPRVNS@HON.M",        Series.load_pattern("1990-01-01", "M", pathHON, "sheet_num:1", "increment:5:1", 41)
    sox.add "KPPRVRSDNS@HON.M",     Series.load_pattern("1990-01-01", "M", pathHON, "sheet_num:1", "increment:5:1", 42)
    sox.add "KPPRVCOMNS@HON.M",     Series.load_pattern("1990-01-01", "M", pathHON, "sheet_num:1", "increment:5:1", 43)
    sox.add "KPPRVADDNS@HON.M",     Series.load_pattern("1990-01-01", "M", pathHON, "sheet_num:1", "increment:5:1", 44)
    sox.add "KPPRVNS@HAW.M",        Series.load_pattern("1990-01-01", "M", pathHAW, "sheet_num:1", "increment:5:1", 41)
    sox.add "KPPRVRSDNS@HAW.M",     Series.load_pattern("1990-01-01", "M", pathHAW, "sheet_num:1", "increment:5:1", 42)
    sox.add "KPPRVCOMNS@HAW.M",     Series.load_pattern("1990-01-01", "M", pathHAW, "sheet_num:1", "increment:5:1", 43)
    sox.add "KPPRVADDNS@HAW.M",     Series.load_pattern("1990-01-01", "M", pathHAW, "sheet_num:1", "increment:5:1", 44)
    sox.add "KPPRVNS@MAU.M",        Series.load_pattern("1990-01-01", "M", pathMAU, "sheet_num:1", "increment:5:1", 41)
    sox.add "KPPRVRSDNS@MAU.M",     Series.load_pattern("1990-01-01", "M", pathMAU, "sheet_num:1", "increment:5:1", 42)
    sox.add "KPPRVCOMNS@MAU.M",     Series.load_pattern("1990-01-01", "M", pathMAU, "sheet_num:1", "increment:5:1", 43)
    sox.add "KPPRVADDNS@MAU.M",     Series.load_pattern("1990-01-01", "M", pathMAU, "sheet_num:1", "increment:5:1", 44)
    sox.add  "KPPRVNS@KAU.M",       Series.load_pattern("1990-01-01", "M", pathKAU, "sheet_num:1", "increment:5:1", 41)
    sox.add "KPPRVRSDNS@KAU.M",     Series.load_pattern("1990-01-01", "M", pathKAU, "sheet_num:1", "increment:5:1", 42)
    sox.add "KPPRVCOMNS@KAU.M",     Series.load_pattern("1990-01-01", "M", pathKAU, "sheet_num:1", "increment:5:1", 43)
    sox.add "KPPRVADDNS@KAU.M",     Series.load_pattern("1990-01-01", "M", pathKAU, "sheet_num:1", "increment:5:1", 44)
...
task :gsp_upd_template => :environment do
  require "Spreadsheet"
...
task :inc_upd_q_template => :environment do
  require "Spreadsheet"
...
task :inc_upd_a_template => :environment do
  require "Spreadsheet"
...
task :com_upd_template => :environment do
  require "Spreadsheet"
