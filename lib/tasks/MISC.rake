...
task :uic_upd => :environment do
	...
	uic = {
		"UICININS@HONO.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 2, :frequency => "W" })/1000|, 
		"UICININS@KANE.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 3, :frequency => "W" })/1000|, 
		"UICININS@WPHU.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 4, :frequency => "W" })/1000|, 
		"UICININS@HON.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 5, :frequency => "W" })/1000|, 
		"UICININS@HILO.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 6, :frequency => "W" })/1000|, 
		"UICININS@KONA.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 7, :frequency => "W" })/1000|, 
		"UICININS@HAW.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 8, :frequency => "W" })/1000|, 
		"UICININS@WLKU.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 9, :frequency => "W" })/1000|, 
		"UICININS@MOLK.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 10, :frequency => "W" })/1000|, 
		"UICININS@MAU.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 11, :frequency => "W" })/1000|, 
		"UICININS@KAU.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 12, :frequency => "W" })/1000|, 
		"UICININS@OT.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 13, :frequency => "W" })/1000|, 
		"UICININS@HI.W" => %Q|Series.load_from_download(  "UIC@hawaii.gov", { :file_type => "xls", :start_date => "2000-08-13", :sheet => "icweekly", :row => "increment:7:1", :col => 14, :frequency => "W" })/1000|, 
