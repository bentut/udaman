...
task :const_upd_m => :environment do
  ...
  sox.add "KPPRVNS@HI",         Series.load_pattern("1990-01-01", "M",  path_CONST_HI, "STATE_2011-07p", "increment:5:1", 41)
  sox.add "KPPRVRSDNS@HI",         Series.load_pattern("1990-01-01", "M",  path_CONST_HI, "STATE_2011-07p", "increment:5:1", 42)
  sox.add "KPPRVCOMNS@HI",         Series.load_pattern("1990-01-01", "M",  path_CONST_HI, "STATE_2011-07p", "increment:5:1", 43)
  sox.add "KPPRVADDNS@HI",         Series.load_pattern("1990-01-01", "M",  path_CONST_HI, "STATE_2011-07p", "increment:5:1", 44)
  sox.add "KPPRVNS@HON",         Series.load_pattern("1990-01-01", "M",  path_CONST_HON, "Honolulu_2011-07p", "increment:5:1", 41)
  sox.add "KPPRVRSDNS@HON",         Series.load_pattern("1990-01-01", "M",  path_CONST_HON, "Honolulu_2011-07p", "increment:5:1", 42)
  sox.add "KPPRVCOMNS@HON",         Series.load_pattern("1990-01-01", "M",  path_CONST_HON, "Honolulu_2011-07p", "increment:5:1", 43)
  sox.add "KPPRVADDNS@HON",         Series.load_pattern("1990-01-01", "M",  path_CONST_HON, "Honolulu_2011-07p", "increment:5:1", 44)
  sox.add "KPPRVNS@HAW",         Series.load_pattern("1990-01-01", "M",  path_CONST_HAW, "Hawaii Cty_2011-07p", "increment:5:1", 41)
  sox.add "KPPRVRSDNS@HAW",         Series.load_pattern("1990-01-01", "M",  path_CONST_HAW, "Hawaii Cty_2011-07p", "increment:5:1", 42)
  sox.add "KPPRVCOMNS@HAW",         Series.load_pattern("1990-01-01", "M",  path_CONST_HAW, "Hawaii Cty_2011-07p", "increment:5:1", 43)
  sox.add "KPPRVADDNS@HAW",         Series.load_pattern("1990-01-01", "M",  path_CONST_HAW, "Hawaii Cty_2011-07p", "increment:5:1", 44)
  sox.add "KPPRVNS@MAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_MAU, "Maui Cty_2011-07p", "increment:5:1", 41)
  sox.add "KPPRVRSDNS@MAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_MAU, "Maui Cty_2011-07p", "increment:5:1", 42)
  sox.add "KPPRVCOMNS@MAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_MAU, "Maui Cty_2011-07p", "increment:5:1", 43)
  sox.add "KPPRVADDNS@MAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_MAU, "Maui Cty_2011-07p", "increment:5:1", 44)
  sox.add "KPPRVNS@KAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_KAU, "Kauai Cty_2011-07p", "increment:5:1", 41)
  sox.add "KPPRVRSDNS@KAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_KAU, "Kauai Cty_2011-07p", "increment:5:1", 42)
  sox.add "KPPRVCOMNS@KAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_KAU, "Kauai Cty_2011-07p", "increment:5:1", 43)
  sox.add "KPPRVADDNS@KAU",         Series.load_pattern("1990-01-01", "M",  path_CONST_KAU, "Kauai Cty_2011-07p", "increment:5:1", 44)
